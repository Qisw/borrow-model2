...
outS.devFracGradIq  = dev_add(tgS.schoolS.fracGrad_qcM(:, iCohort),  aggrS.sqS.fracGrad_qV,  1, ...
   2 * pctFactor, cS.tgS.tgFracGradIq , ...
...
outS.devFracGradYp  = dev_add(tgS.schoolS.fracGrad_ycM(:, iCohort),  aggrS.ypS.fracGrad_yV,  1, ...
   2 * pctFactor, cS.tgS.tgFracGradYp , ...
...
outS.devYpIq = dev_add(tgS.ypS.logYpMean_qcM(:,iCohort), aggrS.iqS.logYpMean_qV, 1,  2, cS.tgS.tgYpIq, 'yp/iq', ...
   'Mean log parental income by IQ quartile', '%.2f');

% By yp quartile
outS.devYpYp = dev_add(tgS.ypS.logYpMean_ycM(:,iCohort), aggrS.ypS.logYpMean_yV, 1,  2, cS.tgS.tgYpYp, 'yp/yp', ...
...
outS.devHours = dev_add(tgS.hoursS.hoursMean_cV(iCohort),  aggrS.entrantYear2S.hoursCollMean, ...
   1, 2 * pctFactor, cS.tgS.tgHours, 'hours', 'Mean hours in college', '%.2f');

outS.devHoursIq = dev_add(tgS.hoursS.hoursMean_qcM(:,iCohort),  aggrS.iqYear2S.hoursCollMean_qV, 1, 2 * pctFactor, ...
   cS.tgS.tgHoursIq, 'hours/iq',  'Mean hours in college by IQ', '%.2f');
outS.devHoursYp = dev_add(tgS.hoursS.hoursMean_ycM(:,iCohort),  aggrS.ypYear2S.hoursCollMean_yV, 1, 2 * pctFactor, ...
...
outS.devEarn  = dev_add(tgS.collEarnS.mean_cV(iCohort),  aggrS.entrantYear2S.earnCollMean, 1, ...
   2 * dollarFactor, cS.tgS.tgEarn, 'earn', ...
   'Mean earnings in college', 'dollar');

outS.devEarnIq  = dev_add(tgS.collEarnS.mean_qcM(:, iCohort),  aggrS.iqYear2S.earnCollMean_qV, 1,  2 * dollarFactor, ...
   cS.tgS.tgEarnIq, 'earn/iq',  'Mean earnings in college by IQ', 'dollar');
outS.devEarnYp  = dev_add(tgS.collEarnS.mean_ycM(:, iCohort),  aggrS.ypYear2S.earnCollMean_yV, 1,  2 * dollarFactor, ...
   cS.tgS.tgEarnYp, 'earn/yp',  'Mean earnings in college by y', 'dollar');


%% Debt of college grads

outS.devDebtGradsFracIq = dev_add(tgS.debtS.fracGrads_qcM(:,iCohort),  aggrS.iqGradS.debtFrac_qV, ...
